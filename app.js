...
let converter = function (origem, destino, valor){
    if(origem === 'c' && destino ==='f') return arredondo(valor * 1.8 +32)
    else if (origem === 'c' && destino ==='k') return arredondo(valor + 273.15)
    else if (origem === 'f' && destino ==='c') return arredondo((valor -32) / 1.8)
    else if (origem === 'f' && destino ==='k') return arredondo(converter('f', 'c', valor )+ 273.15)
    else if (origem === 'k' && destino ==='c') return arredondo(valor - 273.15)
    else if (origem === 'k' && destino ==='f') return arredondo(converter('k', 'c', valor ) * 1.8 +32)
    else return arredondo(valor)
}

let arredondo = function (valor) { return Math.round(valor * 100) / 100}
